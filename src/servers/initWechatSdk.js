...
export default function initWechatSdk(config = {}) {
    ...
    const apiSignURL = `http://localhost:3000/getSdkSign?url=${pageShareURL}`;
        ...
        const configInit = () => {
            ...
            const wxConfig = {
                ...
                imgUrl: config.pageShareimgURL ?
                    ...
                    "?x-oss-process=image/resize,m_fixed,w_200,h_200/quality,Q_60" : "https://glhres.oss-cn-hangzhou.aliyuncs.com/images/logo_share_zhengu.png?x-oss-process=image/resize,m_fixed,w_200,h_200/quality,Q_60",
